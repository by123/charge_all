...
-(UIPickerView *)provincePickerView{
    if(_provincePickerView == nil){
        ...
        _provincePickerView.frame = CGRectMake(0, STHeight(30), ScreenWidth/3, STHeight(320));
...
-(UIPickerView *)cityPickerView{
    if(_cityPickerView == nil){
        ...
        _cityPickerView.frame = CGRectMake(ScreenWidth/3, STHeight(30), ScreenWidth/3, STHeight(320));
...
-(UIPickerView *)areaPickerView{
    if(_areaPickerView == nil){
        ...
        _areaPickerView.frame = CGRectMake((ScreenWidth/3)*2, STHeight(30), ScreenWidth/3, STHeight(320));
