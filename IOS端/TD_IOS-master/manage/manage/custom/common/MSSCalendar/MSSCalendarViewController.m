...
-(void)viewWillAppear:(BOOL)animated{
    [self setStatuBarBackgroud:c02 style:UIStatusBarStyleDefault];
}
...
- (void)addWeakView
{
    UIView *weekView = [[UIView alloc]initWithFrame:CGRectMake(0, StatuBarHeight, MSS_SCREEN_WIDTH, MSS_WeekViewHeight)];
...
- (void)createUI
{
    ...
    _collectionView = [[UICollectionView alloc]initWithFrame:CGRectMake(0, StatuBarHeight + MSS_WeekViewHeight, width * 7, MSS_SCREEN_HEIGHT - StatuBarHeight - MSS_WeekViewHeight) collectionViewLayout:flowLayout];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(cell)
    {
        ...
        cell.dateLabel.text = MSG_EMPTY;
        cell.dateLabel.textColor = MSS_TextColor;
        cell.subLabel.text = MSG_EMPTY;
