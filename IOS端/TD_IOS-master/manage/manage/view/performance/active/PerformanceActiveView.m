...
@interface PerformanceActiveView()<UITableViewDelegate,UITableViewDataSource,STRecentDateViewDelegate,STDateBlockViewDelegate,STPerformanceSearchDelegate>
...
@implementation PerformanceActiveView{
    Boolean isExpand;
}
