...
@interface ChainView()<STSinglePickerLayerViewDelegate,UITextFieldDelegate,STSelectInViewDelegate,STAddressPickerLayerViewDelegate>

@property(strong, nonatomic)ChainViewModel *mViewModel;
...
-(void)initView{
    ...
    [_layerView setData:MSG_INDUSTRYS[1]];
    ...
    [_scrollView setContentSize:CGSizeMake(ScreenWidth, STHeight(50) * 18)];
...
-(void)initBody{
    ...
    [self buildTitle:@"设置分润" height:STHeight(450)];
    UIView *bodyView = [[UIView alloc]initWithFrame:CGRectMake(0, STHeight(500), ScreenWidth, STHeight(100))];
    bodyView.backgroundColor = cwhite;
    [_scrollView addSubview:bodyView];
    
    
    NSString *labelStr = @"分润比例";
...
-(void)onAddBtnClicked{
    ...
    _mViewModel.model.chainName = _nameTF.text;
