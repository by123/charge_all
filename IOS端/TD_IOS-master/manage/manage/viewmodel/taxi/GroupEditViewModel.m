...
@implementation GroupEditViewModel
...
-(void)editGroup{
    ...
    [STLog print:@"上传的数据" content:_model.mj_JSONString];
    WS(weakSelf)
    [STNetUtil post:URL_GROUP_EDIT content:_model.mj_JSONString success:^(RespondModel *respondModel) {
