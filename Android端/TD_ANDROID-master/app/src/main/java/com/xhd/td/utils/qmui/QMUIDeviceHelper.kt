...
import com.tencent.tinker.lib.util.TinkerLog.printErrStackTrace
import java.io.File
    ...
    init {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.O) {
            ...
            try {
                ...
                XLog.e(printErrStackTrace(TAG, e, "read file error"))
        ...
        try {
            ...
            XLog.e(printErrStackTrace(TAG, e, "read SystemProperties error"))
