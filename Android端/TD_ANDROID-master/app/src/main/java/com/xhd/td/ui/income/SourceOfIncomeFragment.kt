...
import com.xhd.td.adapter.income.SourceOfIncomeAdapter
...
class SourceOfIncomeFragment :
    AbstractLoadMoreFragment<IncomeTopBeam, SourceOfIncomeAdapter.ViewHolder, AbstractLoadMoreVM>() {
    ...
    override lateinit var mAdapter: SimpleRecAdapter<IncomeTopBeam, SourceOfIncomeAdapter.ViewHolder>

    override fun initView(view: View) {
        mAdapter = SourceOfIncomeAdapter(context!!)
    ...
    companion object {
        fun newInstance(time: String) = SourceOfIncomeFragment().apply {
            mAtTime = time
        }
    }
