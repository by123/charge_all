...
//        XLog.d("Drawable size = " + compoundDrawables.size + "value = " + compoundDrawables + "")
    ...
    private fun setDrawableBounds(drawable: Drawable?, width: Int, height: Int) {
        if (drawable != null) {
//            XLog.d("width/height" + drawable.intrinsicWidth + "," + drawable.intrinsicHeight)
//            XLog.d("scale = %s", scale)
