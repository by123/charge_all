...
import com.xhd.td.utils.social.ParamsRequired;
...
public final class WXShareEntity extends ShareEntity {
    ...
    public static ShareEntity createTextInfo(@ParamsRequired boolean isTimeLine, @ParamsRequired String text) {
        ShareEntity entity = new ShareEntity(isTimeLine ? Companion.getTYPE_PYQ() : Companion.getTYPE_WX());
        Companion.addParams(entity.getParams(), KEY_WX_TYPE, TYPE_TEXT);
        Companion.addParams(entity.getParams(), KEY_WX_TEXT, text);
        return entity;
    }
    ...
    public static ShareEntity createImageInfo(@ParamsRequired boolean isTimeLine, @ParamsRequired String imgUrl) {
        ShareEntity entity = new ShareEntity(isTimeLine ? Companion.getTYPE_PYQ() : Companion.getTYPE_WX());
        Companion.addParams(entity.getParams(), KEY_WX_TYPE, TYPE_IMG);
        Companion.addParams(entity.getParams(), KEY_WX_IMG_LOCAL, imgUrl);
        return entity;
    }
    ...
    public static ShareEntity createImageInfo(@ParamsRequired boolean isTimeLine, @ParamsRequired int imgRes) {
        ShareEntity entity = new ShareEntity(isTimeLine ? Companion.getTYPE_PYQ() : Companion.getTYPE_WX());
        Companion.addParams(entity.getParams(), KEY_WX_TYPE, TYPE_IMG);
        Companion.addParams(entity.getParams(), KEY_WX_IMG_RES, imgRes);
        return entity;
    }
    ...
    public static ShareEntity createMusicInfo(@ParamsRequired boolean isTimeLine, @ParamsRequired String musicUrl, String imgUrl, String title, String summary) {
        ShareEntity entity = new ShareEntity(isTimeLine ? Companion.getTYPE_PYQ() : Companion.getTYPE_WX());
        Companion.addParams(entity.getParams(), KEY_WX_TYPE, TYPE_MUSIC);
        Companion.addParams(entity.getParams(), KEY_WX_MUSIC_URL, musicUrl);
        addTitleSummaryAndThumb(entity.getParams(), title, summary, imgUrl);
        return entity;
    }
    ...
    public static ShareEntity createMusicInfo(@ParamsRequired boolean isTimeLine, @ParamsRequired String musicUrl, int imgRes, String title, String summary) {
        ...
        Companion.addParams(entity.getParams(), KEY_WX_TYPE, TYPE_MUSIC);
        Companion.addParams(entity.getParams(), KEY_WX_MUSIC_URL, musicUrl);
        addTitleSummaryAndThumb(entity.getParams(), title, summary, imgRes);
        return entity;
    }
    ...
    public static ShareEntity createVideoInfo(@ParamsRequired boolean isTimeLine, @ParamsRequired String videoUrl, String imgUrl, String title, String summary) {
        ShareEntity entity = new ShareEntity(isTimeLine ? Companion.getTYPE_PYQ() : Companion.getTYPE_WX());
        Companion.addParams(entity.getParams(), KEY_WX_TYPE, TYPE_VIDEO);
        Companion.addParams(entity.getParams(), KEY_WX_VIDEO_URL, videoUrl);
        addTitleSummaryAndThumb(entity.getParams(), title, summary, imgUrl);
        return entity;
    }
    ...
    public static ShareEntity createWebPageInfo(@ParamsRequired boolean isTimeLine, @ParamsRequired String webUrl, String imgUrl, String title, String summary) {
        ShareEntity entity = new ShareEntity(isTimeLine ? Companion.getTYPE_PYQ() : Companion.getTYPE_WX());
        Companion.addParams(entity.getParams(), KEY_WX_TYPE, TYPE_WEB);
        Companion.addParams(entity.getParams(), KEY_WX_WEB_URL, webUrl);
        addTitleSummaryAndThumb(entity.getParams(), title, summary, imgUrl);
        return entity;
    }
    ...
    private static void addTitleSummaryAndThumb(Bundle params, String title, String summary, String imgUrl) {
        Companion.addParams(params, KEY_WX_TITLE, title);
        Companion.addParams(params, KEY_WX_SUMMARY, summary);
        Companion.addParams(params, KEY_WX_IMG_LOCAL, imgUrl);
    }
    ...
    private static void addTitleSummaryAndThumb(Bundle params, String title, String summary, int imgRes) {
        Companion.addParams(params, KEY_WX_TITLE, title);
        Companion.addParams(params, KEY_WX_SUMMARY, summary);
        Companion.addParams(params, KEY_WX_IMG_RES, imgRes);
    }
}
