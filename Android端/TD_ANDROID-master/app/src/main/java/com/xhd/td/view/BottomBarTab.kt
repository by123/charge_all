...
class BottomBarTab(
    context: Context,
    attrs: AttributeSet?,
    defStyleAttr: Int, @DrawableRes selectIcon: Int, @DrawableRes unSelectIcon: Int,
    title: CharSequence
    ...
    private var mUnSelectIcon: Int = 0
    ...
    constructor(
        context: Context, @DrawableRes selectIcon: Int, @DrawableRes unSelectIcon: Int,
        title: CharSequence
    ) : this(context, null, selectIcon, unSelectIcon, title)


    constructor(context: Context, attrs: AttributeSet?, selectIcon: Int, unSelectIcon: Int, title: CharSequence) : this(
        context,
        attrs,
        0,
        selectIcon,
    ...
    init {
        init(context, selectIcon, unSelectIcon, title)
    }

    private fun init(context: Context, selectIcon: Int, unSelectIcon: Int, title: CharSequence) {
        mContext = context
        ...
        val size = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 23f, resources.displayMetrics).toInt()
...
//        mIcon!!.setColorFilter(ContextCompat.getColor(context, R.color.tab_unselect))
        ...
        mTvTitle!!.setTextColor(ContextCompat.getColor(context, R.color.text_secondary))
    ...
    override fun setSelected(selected: Boolean) {
        ...
        if (selected) {
            ...
            mIcon?.setImageResource(mUnSelectIcon)
            mTvTitle?.setTextColor(ContextCompat.getColor(mContext!!, R.color.text_secondary))
        }
    }
