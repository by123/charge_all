...
public abstract class BaseNodeViewBinder<T> extends RecyclerView.ViewHolder {
    /**
     ...
     */
    public abstract void bindView(TreeNode<T> treeNode);
     ...
     */
    public void onNodeToggled(TreeNode<T> treeNode, boolean expand) {
        //layout_empty
    }
}
