...
public class TreeView<T> implements SelectableTreeAction<T> {
    ...
    @Override
    public void addNode(TreeNode<T> parent, TreeNode<T> treeNode) {
    ...
    @Override
    public void addNodes(TreeNode<T> parent, List<TreeNode<T>> treeNodes) {
    ...
    @Override
    public void selectNodes(List<TreeNode<T>> treeNodes) {
        if (treeNodes != null) {
            for (TreeNode<T> treeNode : treeNodes) {
                adapter.selectNode(true, treeNode);
            }
    ...
    @Override
    public List<TreeNode<T>> getSelectedParentNodes() {
        return TreeHelper.getSelectedParentNodes(root);
    }
