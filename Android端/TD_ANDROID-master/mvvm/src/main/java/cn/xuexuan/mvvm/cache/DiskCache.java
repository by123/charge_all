package cn.xuexuan.mvvm.cache;

import android.content.Context;
import android.os.Environment;
import android.text.TextUtils;
import cn.xuexuan.mvvm.AppConstants;
import cn.xuexuan.mvvm.utils.Codec;
...
public class DiskCache implements ICache {
    ...
    private DiskCache(Context context) {
        ...
        try {
            ...
            cache = DiskLruCache.open(cacheDir, Kits.Package.INSTANCE.getVersionCode(context), 1, 10 * 1024 * 1024);        //10M
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    private String getCacheDir() {
        return AppConstants.INSTANCE.getCACHE_DISK_DIR();
    }
