...
public class PatternFlattener implements Flattener, Flattener2 {
   ...
   * @return the parameters list, or layout_empty if no parameter found from the given pattern
   */
   ...
   * @return the parameter fillers, or layout_empty if none of the parameters is recognizable
   */
